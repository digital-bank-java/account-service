...
class AccountController {
    ...
    @ApiResponse(
            responseCode = "200",
            description = "Customer accounts returned",
            content =
                    @Content(
                            mediaType = MediaType.APPLICATION_JSON_VALUE,
        ...
        for (var index = 0; index < tokens.size(); index++) {
            ...
            if (property == null) {
                throw new ResponseStatusException(
                        HttpStatus.BAD_REQUEST, "Unsupported sort property: " + propertyToken);
            }
            ...
            if (index + 1 < tokens.size()) {
                ...
                if (isSortDirection(nextToken)) {
                    ...
                    throw new ResponseStatusException(
                            HttpStatus.BAD_REQUEST, "Unsupported sort direction: " + nextToken);
                }
            }
