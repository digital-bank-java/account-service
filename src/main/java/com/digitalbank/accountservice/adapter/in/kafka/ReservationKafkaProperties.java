...
public class ReservationKafkaProperties {
    ...
    public void setAllowInsecureTransport(boolean value) {
    ...
    public void setRequestedTopic(String value) {
        requestedTopic = value;
    }

    public String getReleaseRequestedTopic() {
        return releaseRequestedTopic;
    }

    public void setReleaseRequestedTopic(String value) {
        releaseRequestedTopic = value;
    }
    ...
    public void setAcceptedTopic(String value) {
        acceptedTopic = value;
    }
    ...
    public void setRejectedTopic(String value) {
        rejectedTopic = value;
    }

    public String getReleasedTopic() {
        return releasedTopic;
    }

    public void setReleasedTopic(String value) {
        releasedTopic = value;
    }

    public String getExpiredTopic() {
        return expiredTopic;
    }

    public void setExpiredTopic(String value) {
        expiredTopic = value;
    }
    ...
    public void setRetryDelayMs(long value) {
        retryDelayMs = value;
    }
}
