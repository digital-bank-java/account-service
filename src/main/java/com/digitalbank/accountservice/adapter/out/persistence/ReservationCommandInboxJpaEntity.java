...
class ReservationCommandInboxJpaEntity {
	...
	ReservationCommandInboxJpaEntity(UUID eventId, String eventType, String payloadFingerprint, String reservationRequestId,
			UUID transactionId, String correlationId, String causationId, UUID reservationId, Instant processedAt) {
